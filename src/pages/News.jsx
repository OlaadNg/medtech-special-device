...
const articles = [
  { id: 1, category: 'Medical Innovations', title: 'AI-Powered Diagnostics Revolutionising Early Disease Detection Worldwide', excerpt: 'New deep learning algorithms are enabling rapid, accurate diagnostics in resource-constrained healthcare settings globally, improving outcomes for millions.', image: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=700&q=80', date: 'June 10, 2026', readTime: '5 min', author: 'Dr. Aisha Mohammed', featured: true },
  { id: 2, category: 'Industry Reports', title: "Global Healthcare Reform: What It Means for Medical Equipment Procurement", excerpt: 'Analysis of international healthcare policy trends and their implications for private and public sector medical technology procurement over the next decade.', image: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=700&q=80', date: 'June 5, 2026', readTime: '8 min', author: 'Nokuthula Zulu' },
  { id: 3, category: 'Company News', title: 'MedTech Expands Global Operations With New International Distribution Hub', excerpt: 'MedTech strengthens its worldwide footprint by establishing a full-service clinical engineering and distribution hub to serve international markets.', image: 'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=700&q=80', date: 'May 28, 2026', readTime: '3 min', author: 'Marketing Team' },
  { id: 4, category: 'Healthcare News', title: 'Robotic Surgery Goes Global: MedTech Partners With Intuitive Surgical for da Vinci Distribution', excerpt: 'A landmark partnership brings the da Vinci surgical system to hospitals worldwide, with 12 systems already placed across multiple countries.', image: 'https://images.unsplash.com/photo-1551190822-a9333d879b1f?w=700&q=80', date: 'May 15, 2026', readTime: '6 min', author: 'Dr. Marcus van der Berg' },
  ...
  { id: 6, category: 'Industry Reports', title: 'Global Medical Equipment Market Report 2026: Growth, Trends, and Opportunities', excerpt: 'Comprehensive analysis of the worldwide medical equipment market, projected to reach $612 billion by 2030, with key growth drivers in digital health and AI.', image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=700&q=80', date: 'April 20, 2026', readTime: '12 min', author: 'Research Team' },
];
...
export default function News() {
  ...
  return (
    <div>
      <PageHero
        label="News & Insights"
        title="The Pulse of Global Healthcare Innovation"
