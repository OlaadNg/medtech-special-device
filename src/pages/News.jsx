...
const articles = [
  ...
  { id: 3, category: 'Company News', title: 'MediHub Expands Operations Into East Africa With New Nairobi Regional Office', excerpt: 'MediHub strengthens its pan-African footprint by establishing a full-service clinical engineering and distribution hub in Nairobi, Kenya.', image: 'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=700&q=80', date: 'May 28, 2026', readTime: '3 min', author: 'Marketing Team' },
  { id: 4, category: 'Healthcare News', title: 'Robotic Surgery Comes to Africa: MediHub Partners With Intuitive Surgical for da Vinci Distribution', excerpt: 'A landmark partnership brings the da Vinci surgical system to South African and East African hospitals, with 12 systems already placed.', image: 'https://images.unsplash.com/photo-1551190822-a9333d879b1f?w=700&q=80', date: 'May 15, 2026', readTime: '6 min', author: 'Dr. Marcus van der Berg' },
  { id: 5, category: 'Case Studies', title: 'How Charlotte Maxeke Hospital Reduced ICU Equipment Downtime by 94% With MediHub\'s Fleet Management Programme', excerpt: 'A 12-month case study on how proactive maintenance and real-time fleet monitoring transformed critical care equipment reliability.', image: 'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?w=700&q=80', date: 'May 5, 2026', readTime: '10 min', author: 'Riaan Pretorius' },
