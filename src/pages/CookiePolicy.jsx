  ...
  return (
    <div>
      <PageHero
        label="Legal"
        title="Cookie Policy"
        subtitle="How MedTech Special Device uses cookies and similar technologies on its website."
      />
      <section className="py-16 bg-white">
        <div className="section-container max-w-4xl">
          ...
          <Section title="2. How MedTech Special Device Uses Cookies">
            <p>We use cookies on www.medtechspecialdevice.com and the MedTech Special Device Client Portal for the following purposes:</p>
            <ul className="list-disc ml-6 space-y-2">
              ...
              <li><strong>Marketing Cookies:</strong> Enable us to show relevant MedTech Special Device advertisements on third-party platforms such as LinkedIn and Facebook, and to measure campaign effectiveness.</li>
            </ul>
          </Section>
          ...
          <Section title="4. Third-Party Cookies">
            <p>Some cookies are set by third-party services that appear on our pages. MedTech Special Device does not control these third-party cookies. The third parties involved include:</p>
            <ul className="list-disc ml-6 space-y-2">
          ...
          <Section title="8. Contact">
            ...
            <a href="mailto:privacy@medtechspecialdevice.com" style={{ color: 'var(--medihub-blue)' }}>privacy@medtechspecialdevice.com</a> &nbsp;|&nbsp; +27 11 234 5678</p>
          </Section>
        </div>
      </section>
    </div>
