...
const principles = [
  { Icon: CheckCircle, title: 'Accountability', description: 'MedTech Special Device has appointed a dedicated Information Officer responsible for compliance with POPIA across all divisions and operations.' },
  ...
  { Icon: User, title: 'Data Subject Participation', description: 'Data subjects may request access to, correction of, or deletion of their personal information held by MedTech Special Device at any time.' },
];
  ...
  return (
    <div>
      <PageHero
        ...
        subtitle="MedTech Special Device's commitment to the Protection of Personal Information Act, 4 of 2013 (POPIA)."
      />
      <section className="py-16 bg-white">
        <div className="section-container max-w-4xl">
          ...
          <Section title="2. Our Eight Conditions for Lawful Processing">
            <p>MedTech Special Device's data processing practices are governed by the eight conditions for lawful processing set out in Chapter 3 of POPIA:</p>
          ...
          <Section title="3. Information Officer">
            <p>In compliance with Section 55 of POPIA and the PAIA, MedTech Special Device has registered a designated Information Officer with the Information Regulator of South Africa. The Information Officer is responsible for:</p>
            <ul className="list-disc ml-6 space-y-2">
              <li>Ensuring that MedTech Special Device complies with POPIA at all times.</li>
              ...
              <li>Receiving and managing complaints relating to MedTech Special Device's data processing activities.</li>
            ...
            <div className="mt-4 p-5 rounded-xl" style={{ background: 'var(--clinical-mist)' }}>
              ...
              <strong>Contact:</strong> <a href="mailto:privacy@medtechspecialdevice.com" style={{ color: 'var(--medihub-blue)' }}>privacy@medtechspecialdevice.com</a><br />
              <strong>Postal Address:</strong> 123 Healthcare Drive, Sandton, Johannesburg, 2196</p>
            </div>
          </Section>

          <Section title="4. PAIA Manual">
            <p>In terms of Section 51 of the Promotion of Access to Information Act, 2 of 2000 (PAIA), MedTech Special Device maintains a PAIA Information Manual which describes:</p>
            <ul className="list-disc ml-6 space-y-2">
              <li>The categories of personal information MedTech Special Device holds.</li>
              <li>The purposes for which personal information is processed.</li>
              <li>How to submit a request for access to records held by MedTech Special Device.</li>
              <li>The prescribed fees applicable to PAIA requests.</li>
            </ul>
            <p>To request a copy of MedTech Special Device's PAIA Manual, email <a href="mailto:privacy@medtechspecialdevice.com" style={{ color: 'var(--medihub-blue)' }}>privacy@medtechspecialdevice.com</a>.</p>
          </Section>

          <Section title="5. Data Subject Rights">
            <p>Under POPIA, individuals whose personal information MedTech Special Device processes have the following rights:</p>
            <ul className="list-disc ml-6 space-y-2">
            ...
            <p>To exercise any of these rights, submit a written request to <a href="mailto:privacy@medtechspecialdevice.com" style={{ color: 'var(--medihub-blue)' }}>privacy@medtechspecialdevice.com</a>. We will respond within 30 days as required by POPIA.</p>
          </Section>

          <Section title="6. Data Breach Notification">
            <p>In the event of a data security compromise involving personal information, MedTech Special Device will:</p>
            <ul className="list-disc ml-6 space-y-2">
          ...
          <Section title="7. Special / Sensitive Categories of Information">
            <p>MedTech Special Device recognises that certain categories of information require heightened protection under POPIA, including health information, biometric data, and financial data. Where MedTech Special Device processes such information — for example, in the context of clinical engineering service records — we apply additional safeguards, including:</p>
            <ul className="list-disc ml-6 space-y-2">
          ...
          <Section title="8. Third-Party Processing & Operator Agreements">
            <p>Where MedTech Special Device engages third parties (operators) to process personal information on our behalf, we enter into written data processing agreements that require operators to:</p>
            <ul className="list-disc ml-6 space-y-2">
              <li>Process personal information only on documented instructions from MedTech Special Device.</li>
              <li>Implement appropriate technical and organisational security measures.</li>
              <li>Assist MedTech Special Device in responding to data subject rights requests.</li>
          ...
          <Section title="9. Information Regulator of South Africa">
            <p>Data subjects who are not satisfied with MedTech Special Device's response to a complaint or rights request may contact the Information Regulator of South Africa:</p>
